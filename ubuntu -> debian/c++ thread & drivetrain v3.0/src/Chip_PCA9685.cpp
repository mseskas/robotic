...
Chip_PCA9685::Chip_PCA9685(int chip_addr)
{
    _ticks = 4095;
    __SUBADR1      = 0x02;
    __SUBADR3      = 0x04;
    ...
    reset();
    set_pwm_freq(Chip_PCA9685_HZ);
}

Chip_PCA9685::~Chip_PCA9685()
{
    reset();
}

int Chip_PCA9685::reset()
{
    return wiringPiI2CWriteReg8 (_addr, 0x00, 0x00) ;
}

int Chip_PCA9685::get_pwm_freq()
{
    return _work_frequence;
}

void Chip_PCA9685::set_pwm(int pwn_no, int on_tick, int off_tick)
{
...
// 40 and 1000 Hz
void Chip_PCA9685::set_pwm_freq(int frq_Hz)
{
